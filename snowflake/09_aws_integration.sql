...
CREATE OR REPLACE EXTERNAL ACCESS INTEGRATION aws_philippines_banking_bsp_regulatory_BEDROCK_EAI
  ALLOWED_NETWORK_RULES = (REGULATORY_REPORTING.APP.BEDROCK_NETWORK_RULE)
  ALLOWED_AUTHENTICATION_SECRETS = (REGULATORY_REPORTING.APP.AWS_BEDROCK_SECRET)
  ENABLED = TRUE
  COMMENT = 'Bedrock access for BSP Regulatory Reporting & Compliance Automation';
...
CREATE OR REPLACE FUNCTION APP.BEDROCK_GENERATE(prompt VARCHAR)
  ...
  EXTERNAL_ACCESS_INTEGRATIONS = (aws_philippines_banking_bsp_regulatory_BEDROCK_EAI)
  SECRETS = ('aws_creds' = REGULATORY_REPORTING.APP.AWS_BEDROCK_SECRET)
AS $$
...
CREATE OR REPLACE EXTERNAL ACCESS INTEGRATION aws_philippines_banking_bsp_regulatory_SNS_EAI
  ALLOWED_NETWORK_RULES = (REGULATORY_REPORTING.APP.SNS_NETWORK_RULE)
  ALLOWED_AUTHENTICATION_SECRETS = (REGULATORY_REPORTING.APP.AWS_BEDROCK_SECRET)
  ENABLED = TRUE
